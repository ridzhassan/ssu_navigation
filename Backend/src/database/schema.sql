...
CREATE TABLE IF NOT EXISTS pois (
    ...
    ar_label VARCHAR(255),
    anchor_height DECIMAL(5,2) DEFAULT 1.60,
    icon_scale DECIMAL(5,2) DEFAULT 1.00,
    min_visible_distance DECIMAL(8,2) DEFAULT 3.00,
    max_visible_distance DECIMAL(8,2) DEFAULT 300.00,
    is_active BOOLEAN DEFAULT TRUE,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
